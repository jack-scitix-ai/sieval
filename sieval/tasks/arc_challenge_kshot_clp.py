...
from separation to options after V1, so the DeepSeek-V3 number is the options
target here; the Qwen2.5 report uses separation (see the ppl sibling).
...
@sieval_task(
    ...
    reference_impl=ReferenceImpl(
        ...
        notes=(
            ...
            "--max-logprobs 100). Comparison target: DeepSeek-V3 base "
            "ARC-Challenge 25-shot EM = 94.5 (DeepSeek switched separation->"
            "options after V1; the ppl sibling reproduces the separation "
